...
SMSC_LOGIN = "20magomed00"			# логин клиента
SMSC_PASSWORD = "20kasimov00"	# пароль
...
SMTP_FROM = "magomed.kasimov.2000@mail.ru"		# e-mail адрес отправителя
SMTP_SERVER = "send.smsc.ru"	# адрес smtp сервера
SMTP_LOGIN = "20magomed00"					# логин для smtp сервера
SMTP_PASSWORD = "20kasimov00"				# пароль для smtp сервера
